    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-4 gap-2 text-center text-sm text-gray-600">
        <div className="bg-violet-50 p-2 rounded-xl border border-violet-100">
          <p><span className="font-medium text-violet-700">V:</span> Visual</p>
        </div>
        <div className="bg-blue-50 p-2 rounded-xl border border-blue-100">
          <p><span className="font-medium text-blue-700">A:</span> Auditory</p>
        </div>
        <div className="bg-emerald-50 p-2 rounded-xl border border-emerald-100">
          <p><span className="font-medium text-emerald-700">R:</span> Read/Write</p>
        </div>
        <div className="bg-amber-50 p-2 rounded-xl border border-amber-100">
          <p><span className="font-medium text-amber-700">K:</span> Kinesthetic</p>
        </div>
      </div>
    </div>
  );
